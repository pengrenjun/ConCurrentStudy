...
public class Main1 {  
	...
	public static void main(String[] args) throws Exception {  
      ...
      //这一步的目的就是把消费者的位置信息引用注入到生产者    如果只有一个消费者的情况可以省略 
        ...
        Future<?> future= executors.submit(new Callable<Void>() {  
            ...
            public Void call() throws Exception {  
                ...
                for(int i=0;i<10;i++){
                	...
                	System.out.println("生产线程:"+Thread.currentThread().getName()+" :"+price);  
                    seq = ringBuffer.next();//占个坑 --ringBuffer一个可用区块  
                    ringBuffer.get(seq).setPrice(price);//给这个区块放入 数据 
        ...
        Future<?> future2= executors.submit(new Callable<Void>() {  
            @Override  
            public Void call() throws Exception {  
                long seq;  
                for(int i=0;i<10;i++){
